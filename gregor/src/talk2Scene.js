...
export default class talk2Scene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.json('talk2Data', './assets/text/talk2Data.json'); // 텍스트, 이미지, 사운드 데이터 로드
    }

    create() {
        this.cameras.main.fadeIn(1000);
    
        const textData = this.cache.json.get('talk2Data').contents; // Content.js에 맞춘 구조로 로드
